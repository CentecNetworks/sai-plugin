...
#define CTC_SAI_META_DATA_FDB_DST_MAX   (CTC_MAX_ACL_CID - 1) /* for sdk, 0 is invalid, need mapping from sai*/
#define CTC_SAI_META_DATA_ROUTE_DST_MAX   (CTC_MAX_ACL_CID - 1) /* for sdk, 0 is invalid, need mapping from sai*/
