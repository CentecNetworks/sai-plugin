...
#define QOS_MAP_SAI_TC_TO_CTC_PRI     ((CTC_CHIP_DUET2 == ctcs_get_chip_type(lchip)) ? 2 : 8)
#define QOS_MAP_CTC_PRI_TO_SAI_DSCP   ((CTC_CHIP_DUET2 == ctcs_get_chip_type(lchip)) ? 4 : 1)
        ...
        _In_ const sai_attribute_t *attr_list)
{
    ...
    *qos_map_id = 0;
    ...
    {
        p_map_db->map_type = attr_value->u32;
    }
